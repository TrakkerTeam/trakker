...
<div id="container">
    <div style="display: flex; height: 1000px;">
        <div id="category" class="menu" style="width:10%;">
            <a href="#" onclick="adminList()">관리자 정보</a>
            ...
            <div class="content">
                <div class="header" style="display:flex; height:250px; flex-direction: column;">
                    <div class="container">
                        <h3>회원관리</h3>
                        <div>
                            <button class="btn btn-light" type="button" onclick="memberList()" style="float:right;">
                        ...
                        <div class="col-sm-3">
                            ...
                            <div style="display: flex; flex-direction: column; width: 399%;">
                                <div style="margin-left: auto;">
                                    <button class="btn btn-light" type="button" onclick="tripList()" style="float: right;">
                                        <i class="bi bi-plus-lg" ></i>
                                    </button>
                                </div>
                            </div>
                        ...
                        <div class="container">
                            <div class="col-sm-3">
                                ...
                                <div style="display: flex; flex-direction: column; width: 403%;">
                                    <div style="margin-left: auto;">
                                        <button class="btn btn-light" type="button" onclick="faqList()" style="float: right;">
                                            <i class="bi bi-plus-lg" ></i>
                                        </button>
                                    </div>
                                </div>
