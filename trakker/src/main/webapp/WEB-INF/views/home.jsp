...
<header class="wide-spacing" id="home">
    ...
    <div class="uk-grid-match main-bottom-container uk-grid" uk-grid>
        ...
        " class="uk-width-2-5@m uk-first-column"
...
<div class="container cityListMobileWidth">
    <div class="uk-margin-large info-section pb-5">
        ...
        <div class="uk-slider-container-offset uk-slider uk-slider-container" uk-slider="">
                            ...
                            <div class="uk-cover-container" style="cursor: pointer">
                                <a href="${path}/review/detail?review_num=${review.review_num}">
                                    ...
                                    <div class="uk-overlay-primary uk-position-cover"
                                         style="background: rgba(34, 34, 34, 0.3)"></div>
                                        ...
                                        <div class="card-body align-text-top text-end p-3">
                                            <div class="d-flex justify-content-between align-items-center">
                                                ...
                                                <div class="d-flex justify-content-center align-items-center">
                                                    ...
                                                    <h3 class="mt-3"><fmt:formatNumber
                                                            value="${review.rating.ratingAvg}" pattern="0.0"/></h3>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
            ...
            <ul class="uk-slider-nav uk-dotnav uk-flex-center uk-margin">
                ...
                <li uk-slider-item="6" class=""><a href=""></a></li>
                <li uk-slider-item="7" class="uk-active"><a href=""></a></li>
                <li uk-slider-item="8" class=""><a href=""></a></li>
                <li uk-slider-item="9" class=""><a href=""></a></li>
            </ul>
        </div>
    </div>
    <div class="uk-margin-large info-section">
        ...
        <div class="uk-position-relative uk-visible-toggle uk-light uk-slider uk-slider-container" tabindex="-1"
             uk-slider="">
            <ul class="uk-slider-items uk-grid" id="topCityListForWebPage"
                style="transform: translate3d(0px, 0px, 0px);">
                <c:forEach var="trip" items="${trip}">
                    <a onclick="tripModal(${trip.t_num})"
                       style="color:inherit!important;text-decoration:none!important;" data-bs-toggle="modal"
                       data-bs-target="#trip_a">
                        <div class="uk-panel" style="width: 100%;">
                            <c:set var="img" value="${trip.t_subject}"/>
                            <img src="${path}/resources/images/trip/${img}.jpg"
                                 onerror="this.src='${path}/resources/images/trip/${img}.png'" class="card-img-top"
        ...
        <div class="modal-dialog uk-width-auto uk-margin-auto-vertical">
            <div class="trip_modal-content border-0">
                <div class="uk-grid-match uk-grid-small uk-grid">
                    <button class="uk-modal-close-full uk-close-large uk-icon uk-close" type="button"
            ...
            <div class="row" id="cityList">
                <c:forEach items="${local}" varStatus="i">
                    <div class="col s12 m6 l3" style="flex-basis:20rem!important;">
                        <a onclick="plannerModal(${local[i.index].lnum})"
                           style="color:inherit!important;text-decoration:none!important;" data-bs-toggle="modal"
                           data-bs-target="#plan_d">
                            <div class="city-card-style hoverable z-depth-2" style="margin:0;">
                                <div class="card-image imgbox">
                                    <img src="${path}/resources/images/local/${local[i.index].lnum}/${local[i.index].lnum}-2.jpg"
