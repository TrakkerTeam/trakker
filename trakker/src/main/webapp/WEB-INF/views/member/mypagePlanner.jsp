...
<script>
    ...
    function optionChange(type, param) {
                ...
                location.href='${path}/member/mypagePlanner?'+urlParams.toString();
            }
</script>
<body>
...
<div class="row">
        <div class="col-sm-8">
        <h2 class="ps-5 mt-5">내가 만든 플래너</h2></div>
        <div class="col-sm-4" >
            <div class="d-flex pe-5 mt-5" role="search" action="${path}/member/mypagePlanner">
