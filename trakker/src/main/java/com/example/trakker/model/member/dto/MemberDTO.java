...
public class MemberDTO {
	...
	public String toString() {
		return "MemberDTO [mem_num=" + mem_num + ", manager_num=" + manager_num + ", mem_email=" + mem_email
				+ ", mem_pass=" + mem_pass + ", mem_name=" + mem_name + ", mem_birth=" + mem_birth + ", mem_gender="
				+ mem_gender + ", mem_join_date=" + mem_join_date + ", mem_phone=" + mem_phone + ", mem_zipcode="
				+ mem_zipcode + ", mem_address1=" + mem_address1 + ", mem_address2=" + mem_address2 + ", mem_edit_date="
				+ mem_edit_date + ", mem_nickname=" + mem_nickname + "]";
	}
